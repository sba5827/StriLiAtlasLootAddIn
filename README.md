...
## How to Install
Download the latest [release](https://github.com/sba5827/StriLiAtlasLootAddIn/releases/tag/pre0.2.0). Unzip the folder to your WoW Addons folder. Eg.:
...
And **NOT** like:
    ...
    C:\Users\USERNAME\..\WoW\Interface\AddOns\StriLiAtlasLootAddIn-pre0.2.0
...
Laden Sie die neueste [Version](https://github.com/sba5827/StriLiAtlasLootAddIn/releases/tag/pre0.2.0) herunter. Entpacken Sie den Ordner in Ihren WoW Addons Ordner. z.B.:
...
Und **NICHT** wie:
    ...
    C:\Benutzer\USERNAME\..\WoW\Interface\AddOns\StriLiAtlasLootAddIn-pre0.2.0
